...
-- Insert managers
INSERT INTO GE_TEMPL (empl_user, empl_pers, empl_employee_code, empl_position, empl_department, empl_salary, empl_currency, empl_employment_type, empl_status, empl_work_email, empl_work_phone, empl_work_location, empl_hire_date, empl_is_active) VALUES
((SELECT user_user FROM GE_TUSER WHERE user_username = 'manager01'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'michael.johnson@construction.ca'), 'EMP001', 'Project Manager', 'Construction', 85000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'michael.johnson@construction.ca', '+1-416-555-0101', 'Toronto Office', '2020-01-15', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'manager02'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'sarah.williams@construction.ca'), 'EMP002', 'Operations Manager', 'Construction', 82000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'sarah.williams@construction.ca', '+1-416-555-0102', 'Toronto Office', '2020-03-20', TRUE);

-- Insert supervisors
INSERT INTO GE_TEMPL (empl_user, empl_pers, empl_employee_code, empl_position, empl_department, empl_salary, empl_currency, empl_employment_type, empl_status, empl_work_email, empl_work_phone, empl_work_location, empl_hire_date, empl_is_active) VALUES
((SELECT user_user FROM GE_TUSER WHERE user_username = 'supervisor01'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'david.brown@construction.ca'), 'EMP003', 'Construction Supervisor', 'Construction', 65000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'david.brown@construction.ca', '+1-416-555-0103', 'Toronto Site', '2021-02-10', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'supervisor02'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'jennifer.davis@construction.ca'), 'EMP004', 'Site Supervisor', 'Construction', 62000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'jennifer.davis@construction.ca', '+1-416-555-0104', 'Toronto Site', '2021-05-15', TRUE);

-- Insert employees
INSERT INTO GE_TEMPL (empl_user, empl_pers, empl_employee_code, empl_position, empl_department, empl_salary, empl_currency, empl_employment_type, empl_status, empl_work_email, empl_work_phone, empl_work_location, empl_hire_date, empl_is_active) VALUES
((SELECT user_user FROM GE_TUSER WHERE user_username = 'employee01'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'robert.miller@construction.ca'), 'EMP005', 'Construction Worker', 'Construction', 45000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'robert.miller@construction.ca', '+1-416-555-0105', 'Toronto Site', '2022-01-10', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'employee02'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'lisa.wilson@construction.ca'), 'EMP006', 'Demolition Specialist', 'Demolition', 48000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'lisa.wilson@construction.ca', '+1-416-555-0106', 'Toronto Site', '2022-02-15', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'employee03'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'james.taylor@construction.ca'), 'EMP007', 'Plumber', 'Plumbing', 52000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'james.taylor@construction.ca', '+1-416-555-0107', 'Toronto Site', '2022-03-20', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'employee04'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'amanda.anderson@construction.ca'), 'EMP008', 'Electrician', 'Electrical', 55000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'amanda.anderson@construction.ca', '+1-416-555-0108', 'Toronto Site', '2022-04-25', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'employee05'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'christopher.thomas@construction.ca'), 'EMP009', 'Carpenter', 'Construction', 47000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'christopher.thomas@construction.ca', '+1-416-555-0109', 'Toronto Site', '2022-05-30', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'employee06'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'michelle.jackson@construction.ca'), 'EMP010', 'Mason', 'Construction', 46000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'michelle.jackson@construction.ca', '+1-416-555-0110', 'Toronto Site', '2022-06-05', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'employee07'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'daniel.white@construction.ca'), 'EMP011', 'HVAC Technician', 'HVAC', 54000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'daniel.white@construction.ca', '+1-416-555-0111', 'Toronto Site', '2022-07-10', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'employee08'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'stephanie.harris@construction.ca'), 'EMP012', 'Welder', 'Metal Work', 50000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'stephanie.harris@construction.ca', '+1-416-555-0112', 'Toronto Site', '2022-08-15', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'employee09'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'matthew.clark@construction.ca'), 'EMP013', 'Heavy Equipment Operator', 'Construction', 53000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'matthew.clark@construction.ca', '+1-416-555-0113', 'Toronto Site', '2022-09-20', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'employee10'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'nicole.lewis@construction.ca'), 'EMP014', 'Roofing Specialist', 'Construction', 49000.00, 'CAD', 'FULL_TIME', 'ACTIVE', 'nicole.lewis@construction.ca', '+1-416-555-0114', 'Toronto Site', '2022-10-25', TRUE);

-- =====================================================
-- STEP 4: INSERT CLIENTS DATA
-- =====================================================

INSERT INTO CU_TCLIE (clie_user, clie_pers, clie_client_code, clie_type, clie_company_name, clie_company_industry, clie_contact_person, clie_contact_position, clie_address, clie_city, clie_country, clie_postal_code, clie_currency, clie_status, clie_is_active) VALUES
((SELECT user_user FROM GE_TUSER WHERE user_username = 'client01'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'john.smith@email.com'), 'CLI001', 'CORPORATE', 'Smith Construction Ltd', 'Construction', 'John Smith', 'CEO', '100 Main Street', 'Toronto', 'Canada', 'M5H 1A1', 'CAD', 'ACTIVE', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'client02'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'mary.johnson@email.com'), 'CLI002', 'CORPORATE', 'Johnson Properties Inc', 'Real Estate', 'Mary Johnson', 'President', '200 Oak Avenue', 'Toronto', 'Canada', 'M5V 2T6', 'CAD', 'ACTIVE', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'client03'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'william.brown@email.com'), 'CLI003', 'CORPORATE', 'Brown Development Corp', 'Development', 'William Brown', 'Managing Director', '300 Pine Street', 'Toronto', 'Canada', 'M6G 1L3', 'CAD', 'ACTIVE', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'client04'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'elizabeth.davis@email.com'), 'CLI004', 'CORPORATE', 'Davis Renovations', 'Renovation', 'Elizabeth Davis', 'Owner', '400 Maple Drive', 'Toronto', 'Canada', 'M5B 2L7', 'CAD', 'ACTIVE', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'client05'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'richard.wilson@email.com'), 'CLI005', 'CORPORATE', 'Wilson Contracting', 'Contracting', 'Richard Wilson', 'General Manager', '500 Cedar Lane', 'Toronto', 'Canada', 'M6J 2Z7', 'CAD', 'ACTIVE', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'client06'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'patricia.moore@email.com'), 'CLI006', 'CORPORATE', 'Moore Builders', 'Construction', 'Patricia Moore', 'Operations Director', '600 Elm Street', 'Toronto', 'Canada', 'M5T 2C2', 'CAD', 'ACTIVE', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'client07'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'joseph.taylor@email.com'), 'CLI007', 'CORPORATE', 'Taylor Industrial', 'Industrial', 'Joseph Taylor', 'Plant Manager', '700 Birch Road', 'Toronto', 'Canada', 'M6R 2L5', 'CAD', 'ACTIVE', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'client08'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'linda.anderson@email.com'), 'CLI008', 'CORPORATE', 'Anderson Projects', 'Project Management', 'Linda Anderson', 'Project Director', '800 Willow Way', 'Toronto', 'Canada', 'M5T 2Z5', 'CAD', 'ACTIVE', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'client09'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'thomas.thomas@email.com'), 'CLI009', 'CORPORATE', 'Thomas Construction', 'Construction', 'Thomas Thomas', 'Construction Manager', '900 Spruce Street', 'Toronto', 'Canada', 'M6G 1A5', 'CAD', 'ACTIVE', TRUE),
((SELECT user_user FROM GE_TUSER WHERE user_username = 'client10'), (SELECT pers_pers FROM GE_TPERS WHERE pers_email = 'barbara.jackson@email.com'), 'CLI010', 'CORPORATE', 'Jackson Enterprises', 'Commercial', 'Barbara Jackson', 'Business Owner', '1000 Ash Avenue', 'Toronto', 'Canada', 'M5H 2M9', 'CAD', 'ACTIVE', TRUE);
